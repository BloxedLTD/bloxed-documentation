...
The following are the instructions used to determine the actions of the scraper. These can be used to navigate a page, send data and receive data.
...
In order to group the execution of instruction we have the ability to "iterate".
