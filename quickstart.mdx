...
In this example we want to generate a residential proxy based in Great Britain:
```json
{
...
## Egress
### Webhook
The simplest way to retrieve the output from your scrape (other than as a response from our API). Is to use the [webhook](pipeline/egress/webhook) module.
