...
## Scraping
**IMPORTANT**: 
1. Create a user with the [signup](api-reference/endpoint/user/signup) route.
2. Then use the [retrieve](api-reference/endpoint/user/retrieve) route to fetch your **Organization ID**.
3. [Sign in](api-reference/endpoint/user/login) to fetch the bearer token, cookie or api key.
